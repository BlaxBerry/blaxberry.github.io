<template>
  <div id="home-skills" class="py-10 pb-15">
    ...
    <div class="pa-5">
      <p>
        今までロントからサーバサイトまで広く浅く取り組んできました。最近は Node.js や Rails などに基づいたサーバサイト開発に関する知識も勉強しています。 色々な開発練習を通じて、身に付いているスキルの不足なところも認識しましたが、今後は必ず幅広い面で挑戦して専門性を高め、開発経験を積んだ上で将来オールラウンドに対応できるように頑張りたいと考えています。
      </p>
      <small>
