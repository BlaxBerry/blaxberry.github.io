<template>
  <div id="works" class="pb-15">
    <v-container>
      ...
      <div class="pa-5">
        <p>
          SSR・CSR ウェブサイト、SPA、サーバの開発、PC/Mobile端末 向けのウェブアプリ、フレームワーク...などを日々頑張っており、
          今まで色々な作品開発を通じて、各種のレイアウトやレンダリング、Vue や React の使い方、Ajax技術やサーバの開発などに関する知識を勉強して練習しました。<br>
          フロントからサーバまで、段階的な独自の練習や開発の成果を残してきました。不足なところも認識していますが、今後は必ずスキルを強化し作品を改善し、より良い作品などを提供できるように頑張りたいと思います。
        </p>
        <small>
